...
class crearLlavePdf():
	...
	def llenarByte(self,pos):
		...
		if pos==3:
			self.pdf.set_xy(80,75)
			self.pdf.cell(5,5,"1",1,1,'C')
			self.pdf.text(50,80,"BYE")
		if pos==4:
			self.pdf.set_xy(80,260)
			self.pdf.cell(5,5,"2",1,1,'C')
			self.pdf.text(50,270,"BYE")
		if pos==5:
			self.pdf.set_xy(80,100)
			self.pdf.cell(5,5,"3",1,1,'C')
			self.pdf.text(50,100,"BYE")
		if pos==6:
	...
	def llaveEight(self,dato,parti,gen,titulo):
		...
		self.pdf.add_page()
		self.titulo(titulo)
		self.pdf.set_xy(90,100)
		self.pdf.line(80,80,90,80)
		self.pdf.line(80,100,90,100)
		self.pdf.line(90,80,90,100)
		self.pdf.line(90,90,120,90)
		self.pdf.line(120,90,120,135)
		self.pdf.line(90,135,120,135)
		self.pdf.line(90,120,90,150)
		self.pdf.line(80,130,90,130)
		self.pdf.line(80,150,90,150)
		...
		self.pdf.line(80,180,90,180)
		self.pdf.line(80,210,90,210)
		self.pdf.line(80,240,90,240)
		self.pdf.line(80,270,90,270)
	...
	def ingresarNombreEigth(self,dato,pos):
		if pos==1:
			self.pdf.set_xy(80,70)
			self.pdf.cell(5,5,"1",1,1,'C')
			self.pdf.text(20,75,unicode(dato[0]+" "+dato[1]))
			self.pdf.text(20,80,unicode(dato[2]))
		if pos==2:
			self.pdf.set_xy(80,260)
			self.pdf.cell(5,5,"2",1,1,'C')
			self.pdf.text(20,260,unicode(dato[0]+" "+dato[1]))
			self.pdf.text(20,265,unicode(dato[2]))
		if pos==3:
			self.pdf.set_xy(80,80)
			self.pdf.cell(5,5,"3",1,1,'C')
			self.pdf.text(20,95,unicode(dato[0]+" "+dato[1]))
			self.pdf.text(20,100,unicode(dato[2]))
		if pos==4:
			self.pdf.set_xy(80,230)
			self.pdf.cell(5,5,"4",1,1,'C')
			self.pdf.text(20,230,unicode(dato[0]+" "+dato[1]))
			self.pdf.text(20,235,unicode(dato[2]))
		if pos==5:
			self.pdf.set_xy(80,110)
			self.pdf.cell(5,5,"5",1,1,'C')
			self.pdf.text(30,110,unicode(dato[0]+" "+dato[1]))
			self.pdf.text(30,115,unicode(dato[2]))
		if pos==6:
			self.pdf.set_xy(80,200)
			self.pdf.cell(5,5,"6",1,1,'C')
			self.pdf.text(20,200,unicode(dato[0]+" "+dato[1]))
			self.pdf.text(20,205,unicode(dato[2]))
		if pos==7:
			self.pdf.set_xy(80,140)
			self.pdf.cell(5,5,"7",1,1,'C')
			self.pdf.text(20,140,unicode(dato[0]+" "+dato[1]))
			self.pdf.text(20,145,unicode(dato[2]))
		if pos==8:
			self.pdf.set_xy(80,170)
			self.pdf.cell(5,5,"8",1,1,'C')
			self.pdf.text(20,170,unicode(dato[0]+" "+dato[1]))
			self.pdf.text(20,175,unicode(dato[2]))
